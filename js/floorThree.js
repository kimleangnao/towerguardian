$(function(){
	...
	let maxBossHp = localStorage.getItem("ThreebossHp");
	let bossAttack = 150;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("ThreebossName");
	let currentBossHp = localStorage.getItem("ThreebossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 200;
			...
			$("#nextFloor").on("click", function(){
				window.location.replace("floorFour.html");
			});
		});
	...
	$("#previousFloor").on('click', function(){
		window.location.replace("floorTwo.html");
	});
