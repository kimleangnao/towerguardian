$(function(){
	...
	let maxBossHp = localStorage.getItem("TenbossHp");
	let bossAttack = 555;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("TenbossName");
	let currentBossHp = localStorage.getItem("TenbossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 999;
