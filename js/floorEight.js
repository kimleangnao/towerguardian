$(function(){
	...
	let maxBossHp = localStorage.getItem("EightbossHp");
	let bossAttack = 450;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("EightbossName");
	let currentBossHp = localStorage.getItem("EightbossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 650;
			...
			$("#nextFloor").on("click", function(){
				window.location.replace("floorNine.html");
			});
		});
	...
	$("#previousFloor").on('click', function(){
		window.location.replace("floorSeven.html");
	});
