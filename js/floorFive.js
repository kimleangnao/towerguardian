$(function(){
	...
	let maxBossHp = localStorage.getItem("FivebossHp");
	let bossAttack = 260;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("FivebossName");
	let currentBossHp = localStorage.getItem("FivebossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 300;
