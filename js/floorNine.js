$(function(){
	...
	let maxBossHp = localStorage.getItem("NinebossHp");
	let bossAttack = 500;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("NinebossName");
	let currentBossHp = localStorage.getItem("NinebossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 780;
