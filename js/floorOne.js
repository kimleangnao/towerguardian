$(function(){
	...
	let maxBossHp = localStorage.getItem("OnebossHp");
	let bossAttack = 75;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("OnebossName");
	let currentBossHp = localStorage.getItem("OnebossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 70;
