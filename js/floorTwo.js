$(function(){
	...
	let maxBossHp = localStorage.getItem("TwobossHp");
	let bossAttack = 120;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("TwobossName");
	let currentBossHp = localStorage.getItem("TwobossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 120;
