$(function(){
	...
	let maxBossHp = localStorage.getItem("SevenbossHp");
	let bossAttack = 380;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("SevenbossName");
	let currentBossHp = localStorage.getItem("SevenbossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 510;
			...
			$("#nextFloor").on("click", function(){
				window.location.replace("floorEight.html");
			});
		});
	...
	$("#previousFloor").on('click', function(){
		window.location.replace("floorSix.html");
	});
