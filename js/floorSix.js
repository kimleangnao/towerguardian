$(function(){
	...
	let maxBossHp = localStorage.getItem("SixbossHp");
	let bossAttack = 320;
	let currentFloor = localStorage.getItem("Floor");

	//console.log(userHp + " - " + userMana + " - " + userExp + " - " + currentFloor);
	let currentBossName = localStorage.getItem("SixbossName");
	let currentBossHp = localStorage.getItem("SixbossHp");
	...
	$("#bossPic").on('click', function(){
		...
		$("#confirm").on('click', function(){
			//console.log("dog");
			let newExp = parseInt(userExp) + 400;
